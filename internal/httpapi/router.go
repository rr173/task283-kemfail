...
func writeErr(w http.ResponseWriter, err error) {
	...
	switch err {
	case model.ErrRunNotFound, model.ErrParamNotFound, model.ErrDeviceNotFound,
		model.ErrEventNotFound, model.ErrCandidateNotFound, model.ErrSnapshotNotFound:
		status = http.StatusNotFound
	case model.ErrRunSealed, model.ErrDuplicateEvent, model.ErrParamLineageCycle,
		model.ErrParamMissingBaseline, model.ErrParamVersionRegression, model.ErrDeviceStateRegression,
		model.ErrInvalidDigest, model.ErrSnapshotFrozen, model.ErrEventExcluded, model.ErrInvalidState:
